        ...
        $permissions = [
            ...
            */
            ...
            [
                ...
                'model'             => 'Modules\Accounting\Models\AccountingAccount',
                'model_prefix'      => 'contabilidad',
                'slug_alt'          => 'cuentas_patrimoniales.eliminar',
            ...
            */
            ...
            [
                ...
                'model'             => 'Modules\Accounting\Models\AccountingEntry',
                'model_prefix'      => 'contabilidad',
                'slug_alt'          => 'asiento_contable.editar',
            ...
            [
                ...
                'model'             => 'Modules\Accounting\Models\AccountingEntry',
                'model_prefix'      => 'contabilidad',
                'slug_alt'          => 'asiento_contable.eliminar',
                'short_description' => 'eliminar asiento contable'
            ],
            [
                'name'              => 'Aprobar asientos contables',
                'slug'              => 'accounting.entries.approve',
                'description'       => 'Acceso para aprobar asiento contable',
                'model'             => 'Modules\Accounting\Models\AccountingEntry',
                'model_prefix'      => 'contabilidad',
                'slug_alt'          => 'asiento_contable.approve',
                'short_description' => 'aprobar asiento contable'
            ],
            [
            ...
            */
            [
                'name'              => 'vista principal de la configuración',
                'slug'              => 'accounting.setting.index',
            ...
            [
                ...
                'model_prefix'      => 'contabilidad',
                'slug_alt'          => 'configuracion_categoria.guardar',
                'short_description' => 'guardar categoria'
            ],
            [
                ...
                'model'             => 'Modules\Accounting\Models\AccountingEntryCategory',
                'model_prefix'      => 'contabilidad',
                'slug_alt'          => 'configuracion_categoria.actualizar',
                'short_description' => 'actualizar categoria'
            ],
            [
                ...
                'model'             => 'Modules\Accounting\Models\AccountingEntryCategory',
                'model_prefix'      => 'contabilidad',
                'slug_alt'          => 'configuracion_categoria.eliminar',
            ...
            */
            [
                'name'              => 'Vista principal para los reportes de libros contables',
                'slug'              => 'accounting.report.accountingbooks',
                'description'       => 'Acceso a la vista principal de reportes de los libros contables',
                'model'             => '',
                'model_prefix'      => 'contabilidad',
                'slug_alt'          => 'vista_principal_reportes_libros_contables',
                'short_description' => 'acceso a la vista principal de reportes de libros contables'
            ],
            [
                'name'              => 'Vista principal para los reportes de estados financieros',
                'slug'              => 'accounting.report.financestatements',
                'description'       => 'Acceso a la vista principal de reportes de estados financieros',
                'model'             => '',
                'model_prefix'      => 'contabilidad',
                'slug_alt'          => 'vista_principal_reportes_estados_financieros',
                'short_description' => 'acceso a la vista principal de reportes de estados financieros'
            ],
            ...
            [
                ...
                'model'             => '',
                'model_prefix'      => 'contabilidad',
                'slug_alt'          => 'reporte_libro_diario.pdf',
            ...
            [
                ...
                'model'             => '',
                'model_prefix'      => 'contabilidad',
                'slug_alt'          => 'reporte_balance_comprobación.pdf',
            ...
            [
                ...
                'model'             => '',
                'model_prefix'      => 'contabilidad',
                'slug_alt'          => 'reporte_mayor_analítico.pdf',
            ...
            [
                ...
                'model'             => '',
                'model_prefix'      => 'contabilidad',
                'slug_alt'          => 'reporte_libro_auxiliar.pdf',
            ...
            [
                ...
                'model'             => '',
                'model_prefix'      => 'contabilidad',
                'slug_alt'          => 'reporte_balance_general.pdf',
            ...
            */
            [
                'name'              => 'vista principal del dashboard del módulo de contabilidad',
                'slug'              => 'accounting.dashboard',
                'description'       => 'Acceso para visualizar el dashboard del módulo',
                'model'             => '',
                'model_prefix'      => 'contabilidad',
                'slug_alt'          => 'panel_de_control.ver',
                'short_description' => 'Visualizar panel de control del módulo de contabilidad'
            ],
        ];
