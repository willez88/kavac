...
class AccountingBalanceSheetController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->middleware('permission:accounting.report.balancesheet', ['only' => ['pdf','pdfVue', 'pdfSign','pdfVueSign']]);
    }
    ...
    public function pdfSign($report)
    {
        ...
        */
        ...
        $sign = $pdf->setHeader('Reporte de Contabilidad', 'Reporte de Balance General');
        $pdf->setFooter();
