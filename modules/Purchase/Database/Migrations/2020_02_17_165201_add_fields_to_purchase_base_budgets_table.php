...
class AddFieldsToPurchaseBaseBudgetsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('purchase_base_budgets', function (Blueprint $table) {
            if (!Schema::hasColumn('purchase_base_budgets', 'purchase_requirement_item_id')) {
            ...
            if (!Schema::hasColumn('purchase_base_budgets', 'purchase_requirement_id')) {
            ...
            if (!Schema::hasColumn('purchase_base_budgets', 'unit_price')) {
