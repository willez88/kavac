...
Route::group([
     ...
     */
    Route::get(
        'accounts', 'BudgetAccountController@index'
    ...
    Route::get(
        'accounts/egress-list/{to_formulate?}', 'BudgetAccountController@egressAccounts'
    )->name('budget.accounts.egresslist');
    Route::get(
        'detail-accounts/{id}', 'BudgetAccountController@getDetail'
    )->name('budget.accounts.detail');
    Route::get(
        'set-children-account/{parent_id}', 'BudgetAccountController@setChildrenAccount'
    ...
    Route::get(
        'projects/vue-list/{active?}', 'BudgetProjectController@vueList'
    ...
    Route::get(
        'centralized-actions/vue-list/{active?}', 'BudgetCentralizedActionController@vueList'
    ...
    Route::get(
        'specific-actions/vue-list/{active?}', 'BudgetSpecificActionController@vueList'
    ...
    Route::get(
        'detail-specific-actions/{id}', 'BudgetSpecificActionController@getDetail'
    ...
    Route::get(
        'subspecific-formulations/vue-list', 'BudgetSubSpecificFormulationController@vueList'
    )->name('budget.subspecific-formulations.vuelist');
    Route::get(
        'subspecific-formulations/show/{id}', 'BudgetSubSpecificFormulationController@show'
    )->name('budget.subspecific-formulations.show');
    Route::get(
        'get-subspecific-formulation/{id}', 'BudgetSubSpecificFormulationController@getFormulation'
    ...
    Route::post(
        'get-import-formulation', 'BudgetSubSpecificFormulationController@importFormulation'
    ...
    Route::get(
        'modifications/{type}', 'BudgetModificationController@create'
    )->name('budget.modifications.create');
    Route::post(
        'modifications', 'BudgetModificationController@store'
    )->name('budget.modifications.store');
    Route::get(
        'modifications/{type}/{modification}/edit', 'BudgetModificationController@edit'
    )->name('budget.modifications.edit');
    Route::put(
        'modifications/{modification}', 'BudgetModificationController@update'
