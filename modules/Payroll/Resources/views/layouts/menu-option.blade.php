...
<li>
    ...
    <ul class="submenu" style="{!! display_submenu('payroll') !!}">
        ...
        <li>
            <a href="javascript:void(0)" data-toggle="tooltip" data-placement="right" title="Gestiona la generación de reportes de resumen de disfrute de vacaciones, estatus de vacaciones, cálculo del bono vacacional e histórico de pago de bono vacacional.">Reportes</a>
            <ul class="submenu" style="{!! display_submenu('reports') !!}">
                <li title="Reporte del resumen de disfrute de vacaciones" data-toggle="tooltip" data-placement="right" class="{!! set_active_menu('payroll.reports.vacation-enjoyment-summaries') !!}">
                    <a href="{{ route('payroll.reports.vacation-enjoyment-summaries') }}">
                        Resumen de Disfrute de vacaciones
                    </a>
                </li>
                <li title="Reporte del estatus de vacaciones" data-toggle="tooltip" data-placement="right" class="{!! set_active_menu('payroll.reports.vacation-status') !!}">
