								...
								<tr>
									...
									<td>
										<div class="d-inline-flex">
											<a href="{{ route('positions.edit', $position) }}" class="btn btn-danger btn-xs btn-icon btn-round" data-toggle="tooltip" title="Actualizar"><i class="icofont icofont-edit"></i></a>
