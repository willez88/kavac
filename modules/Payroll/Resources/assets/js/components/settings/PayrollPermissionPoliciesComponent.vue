                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group is-required">
        							...
        							<input type="number" id="anticipation_day" placeholder="Días de anticipación para solicitar el permiso"
        								   class="form-control input-sm" v-model="record.anticipation_day" data-toggle="tooltip"
        								   title="Indique el día de anticipación para solicitar el permiso">
        	                    </div>
                            </div>
                        </div>
						<div class="row">
							<h6> Dias de validación del permiso </h6>
							<div class="col-md-6">
								<div class="form-group is-required">
