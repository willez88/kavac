<template>
	<section class="text-center" id="payroll_staff_classification">
		...
		<div class="modal fade text-left" tabindex="-1" role="dialog" id="add_payroll_staff_classification">
			<div class="modal-dialog vue-crud" role="document">
				<div class="modal-content">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
        							...
        							<input type="text" id="description" placeholder="Descripción"
        								   ...
        								   title="Indique la descripción de la clasificación del personal (requerido)">
        	                    </div>
                            </div>
                        </div>
	                </div>
					<div class="modal-footer">
	                	<div class="form-group">
	                		<modal-form-buttons :saveRoute="'payroll/staff-classifications'"></modal-form-buttons>
	                	</div>
	                </div>
	                <div class="modal-body modal-table">
	                	<v-client-table :columns="columns" :data="records" :options="table_options">
	                		<div slot="id" slot-scope="props" class="text-center">
		                		...
		                		<button @click="deleteRecord(props.row.id, 'payroll/staff-classifications')"
...
<script>
	export default {
		...
		mounted () {
			const vm = this;
			$("#add_payroll_staff_classification").on('show.bs.modal', function() {
                vm.reset();
            });
		},
	};
