<template>
	<section class="text-center" id="payroll_staff_type">
		...
		<div class="modal fade text-left" tabindex="-1" role="dialog" id="add_payroll_staff_type">
			<div class="modal-dialog vue-crud" role="document">
				<div class="modal-content">
                            ...
                            <div class="col-md-6">
        						<div class="form-group is-required">
        							...
        							<input type="text" id="name" placeholder="Nombre"
        								   ...
        								   title="Indique el nombre del tipo de personal (requerido)">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
        							...
        							<input type="text" id="description" placeholder="Descripción"
        								   ...
        								   title="Indique la descripción del tipo de personal (requerido)">
        	                    </div>
                            </div>
                        </div>
	                </div>
					<div class="modal-footer">
	                	<div class="form-group">
	                		<modal-form-buttons :saveRoute="'payroll/staff-types'"></modal-form-buttons>
	                	</div>
	                </div>
	                <div class="modal-body modal-table">
	                	<v-client-table :columns="columns" :data="records" :options="table_options">
	                		<div slot="id" slot-scope="props" class="text-center">
		                		...
		                		<button @click="deleteRecord(props.row.id, 'payroll/staff-types')"
