<template>
	<section class="text-center" id="payroll_position_type">
			...
			<div class="modal-dialog vue-crud" role="document">
				<div class="modal-content">
					...
					<div class="modal-footer">
	                	<div class="form-group">
	                		<modal-form-buttons :saveRoute="app_url + '/payroll/position-types'"></modal-form-buttons>
	                	</div>
	                </div>
	                <div class="modal-body modal-table">
	                	<v-client-table :columns="columns" :data="records" :options="table_options">
	                		<div slot="id" slot-scope="props" class="text-center">
		                		...
		                		<button @click="deleteRecord(props.row.id, 'payroll/position-types')"
...
<script>
	export default {
		...
		mounted () {
			const vm = this;
			$("#add_payroll_position_type").on('show.bs.modal', function() {
                vm.reset();
            });
		},
	};
