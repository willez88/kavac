<template>
	<section class="text-center" id="payroll_gender">
		<a class="btn-simplex btn-simplex-md btn-simplex-primary" href=""
		   title="Registros de géneros" data-toggle="tooltip"
		   @click="addRecord('add_payroll_gender', 'payroll/genders', $event)">
				...
				<div class="modal-content">
					...
					<div class="modal-footer">
	                	<div class="form-group">
	                		<modal-form-buttons :saveRoute="app_url + '/payroll/genders'"></modal-form-buttons>
	                	</div>
	                </div>
	                <div class="modal-body modal-table">
	                	<v-client-table :columns="columns" :data="records" :options="table_options">
	                		<div slot="id" slot-scope="props" class="text-center">
		                		...
		                		<button @click="deleteRecord(props.row.id, 'payroll/genders')"
...
<script>
	export default {
		...
		mounted () {
			const vm = this;
			$("#add_payroll_gender").on('show.bs.modal', function() {
                vm.reset();
            });
		},
	};
