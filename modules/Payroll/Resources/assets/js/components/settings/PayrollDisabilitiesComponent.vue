			...
			<div class="modal-dialog vue-crud" role="document">
				<div class="modal-content">
                            ...
                            <div class="col-md-6">
        						<div class="form-group is-required">
        							...
        							<input type="text" id="name" placeholder="Nombre"
        								   ...
        								   title="Indique el nombre de la discapacidad (requerido)">
					...
					<div class="modal-footer">
	                	<div class="form-group">
	                		<modal-form-buttons :saveRoute="app_url + '/payroll/disabilities'"></modal-form-buttons>
	                	</div>
	                </div>
	                <div class="modal-body modal-table">
	                	<v-client-table :columns="columns" :data="records" :options="table_options">
	                		<div slot="id" slot-scope="props" class="text-center">
		                		...
		                		<button @click="deleteRecord(props.row.id, 'payroll/disabilities')"
...
<script>
	export default {
		...
		mounted () {
			const vm = this;
			$("#add_payroll_disability").on('show.bs.modal', function() {
                vm.reset();
            });
		},
	};
