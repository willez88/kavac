<template>
    <section>
        <div id="SaleBillRejected" class="modal fade text-left" tabindex="-1" role="dialog">
            <div class="modal-dialog modal-xs" role="document">
                <div class="modal-content">
                            ...
                            <div class="col-md-12">
                                <div class="form-group is-required">
                                    <label>Motivo del rechazo:</label>
                                        <textarea type="text"
                                                  class="form-control input-sm is-required" data-toggle="tooltip"
                                                  title="Indique el motivo del rechazo"
                                                  v-model="record.rejected_reason">
                                        </textarea>
                                </div>
                            </div>
                            <div class="col-md-12">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" @click="updateRecord('/sale/bills/bill-rejected/')"
