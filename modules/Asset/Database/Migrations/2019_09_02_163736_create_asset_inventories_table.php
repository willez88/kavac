 ...
 * @brief Crear tabla de los registros de inventario actual de bienes
 *
 * Gestiona la creación o eliminación de la tabla de registros de inventario actual de bienes
 *
