    ...
    public function up()
    {
        ...
        if (!Schema::hasTable('asset_categories')) {
            Schema::create('asset_categories', function (Blueprint $table) {
                ...
                $table->unique(array('asset_type_id', 'code','name'))->comment('Clave única para el registro');
            });
        ...
        if (!Schema::hasTable('asset_disincorporations')) {
            Schema::create('asset_disincorporations', function (Blueprint $table) {
                ...
                $table->integer('asset_disincorporation_motive_id')->nullable()->unsigned()->comment('Identificador único del motivo de la desincorporación del bien');
                $table->foreign('asset_disincorporation_motive_id')->references('id')->on('asset_disincorporation_motives');
        ...
        if (!Schema::hasTable('assets')) {
            Schema::create('assets', function (Blueprint $table) {
                ...
                $table->integer('asset_type_id')->unsigned()->comment('Identificador único del tipo de bien (1 Mueble, 2 Inmueble)');
                $table->foreign('asset_type_id')->references('id')->on('asset_types')
                      ->onDelete('restrict')->onUpdate('cascade');
                
                $table->integer('asset_category_id')->unsigned()->comment('Identificador único de la categoria general a la que pertence el bien');
                $table->foreign('asset_category_id')->references('id')->on('asset_categories')
                      ->onDelete('restrict')->onUpdate('cascade');

                $table->integer('asset_subcategory_id')->unsigned()->comment('Identificador único de la subcategoria a la que pertence el bien');
                $table->foreign('asset_subcategory_id')->references('id')->on('asset_subcategories')
                      ->onDelete('restrict')->onUpdate('cascade');

                $table->integer('asset_specific_category_id')->unsigned()->comment('Identificador único de la categoria especifica a la que pertence el bien');
                $table->foreign('asset_specific_category_id')->references('id')->on('asset_specific_categories')
                      ->onDelete('restrict')->onUpdate('cascade');

                $table->integer('asset_condition_id')->nullable()->unsigned()->comment('Identificador único de la condicion física del bien');
                $table->foreign('asset_condition_id')->references('id')->on('asset_conditions')
                      ->onDelete('restrict')->onUpdate('cascade');

                $table->integer('asset_acquisition_type_id')->nullable()->unsigned()->comment('Identificador único del tipo de adquisicion del bien');                
                ...
                $table->integer('asset_status_id')->nullable()->unsigned()->comment('Identificador único del estatus de uso del bien');
                $table->foreign('asset_status_id')->references('id')->on('asset_status')
                      ->onDelete('restrict')->onUpdate('cascade');

                $table->integer('asset_use_function_id')->nullable()->unsigned()->comment('Identificador único de la función de uso del bien (solo para bienes inmuebles)');
                ...
                $table->integer('parish_id')->nullable()->unsigned()->comment('Identificador único de la parroquia donde esta ubicado el bien');
        ...
        if (!Schema::hasTable('asset_request_assets')) {    
            Schema::create('asset_request_assets', function (Blueprint $table) {
                ...
                $table->integer('asset_request_id')->unsigned()->nullable()->comment('Identificador único de la solicitud generada');
