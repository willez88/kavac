            ...
            <div class="row">
                    ...
                    <div class=" form-group">
                        ...
                        <div class="col-12">
                            <div class="col-12 bootstrap-switch-mini">
                                <input type="radio" name="type_graph_assets" value="exist" id="sel_product_exist"
                ...
                <div class="col-md-3">
                    <div class=" form-group">
                        ...
                        <div class="col-12">
                            <div class="col-12 bootstrap-switch-mini">
                                <input type="radio" name="type_graph_assets" value="max_request"
                ...
                <div class="col-md-3">
                    <div class=" form-group">
                        ...
                        <div class="col-12">
                            <div class="col-12 bootstrap-switch-mini">
                                <input type="radio" name="type_graph_assets" value="min_request"
