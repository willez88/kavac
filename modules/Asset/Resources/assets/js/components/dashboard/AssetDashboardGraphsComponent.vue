            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class=" form-group">
                        ...
                        <div class="col-12">
                            <input type="radio" name="type_graph_assets" value="exist" id="sel_product_exist" checked 
                                   class="form-control bootstrap-switch bootstrap-switch-mini sel_graph_assets" 
                ...
                <div class="col-md-3">
                    <div class=" form-group">
                        ...
                        <div class="col-12">
                            <input type="radio" name="type_graph_assets" value="max_request" id="sel_product_max_request" 
                                   class="form-control bootstrap-switch bootstrap-switch-mini sel_graph_assets" 
                                   data-on-label="SI" data-off-label="NO">
                        </div>
                    </div>
                ...
                <div class="col-md-3">
                    <div class=" form-group">
                        ...
                        <div class="col-12">
                            <input type="radio" name="type_graph_assets" value="min_request" id="sel_product_min_request" 
                                   class="form-control bootstrap-switch bootstrap-switch-mini sel_graph_assets" 
                                   data-on-label="SI" data-off-label="NO">
                        </div>
                    </div>
    ...
    export default {
        data() {
            return {
                ...
                title: 'Bienes Institucionales Registrados',
                ...
                if (vm.records.length > 0) {
                    ...
                    if(vm.record.type_graph_assets == 'exist') {
                        $.each(fields, function(indice, field) {
                            data.push(field.total);
                            labels.push(field.asset_specific_category.name);
                            descriptions.push('Unidad:  Unidad (und)');
                        });
                    } else {
                        $.each(fields, function(indice, field) {
                            data.push(field.total);
        ...
        mounted() {
            const vm = this;
            this.reset();
            this.switchHandler('type_graph_assets');
            this.update();

            $('.sel_graph_assets').on('switchChange.bootstrapSwitch', function(e) {
                vm.update();
            });
        },
        watch: {
